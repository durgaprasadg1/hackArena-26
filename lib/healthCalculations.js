...
/**
 * Calculate daily calorie burn target for exercise section
 * @param {string} goalType - Goal type string
 * @returns {number} Calorie burn target in kcal/day
 */
export function calculateCalorieBurnTarget(goalType) {
  const targets = {
    lose_weight: 400,
    gain_weight: 200,
    maintain: 250,
